    ...
    <div class="col-xs-12">
        <div class="row no-gutter">
            <div class="col-xs-3 js-img-navigation_column" data-module_name="navigation_column">
                ...
                <img class="on-element hide" src="{$moduleImgUri}/wireframe/category/navigation-column-selected.jpg"/>
            </div>
            <div class="col-xs-9">
                <div class="row no-gutter">
                    <div class="col-xs-12 js-img-categories" data-module_name="categories">
                        ...
                        <img class="on-element hide" src="{$moduleImgUri}/wireframe/category/category-selected.jpg"/>
                    </div>
                    <div class="col-xs-12 js-img-content" data-module_name="content">
                        ...
                        <img class="on-element hide" src="{$moduleImgUri}/wireframe/category/content-selected.jpg"/>
                    </div>
                </div>
            </div>
        </div>
