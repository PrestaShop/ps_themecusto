...
<div class="row no-gutter js-wireframe">
    <div class="col-xs-12 js-img-menu" data-module_name="menu">
        ...
        <img class="on-element hide" src="{$moduleImgUri}/wireframe/commons/header-selected.jpg"/>
    </div>
    <div class="col-xs-12 js-img-slider" data-module_name="slider">
        ...
        <img class="on-element hide" src="{$moduleImgUri}/wireframe/homepage/slider-selected.jpg"/>
    </div>
    <div class="col-xs-12 js-img-home_products" data-module_name="home_products">
        ...
        <img class="on-element hide" src="{$moduleImgUri}/wireframe/homepage/home_products-selected.jpg"/>
    </div>
    <div class="col-xs-12 js-img-block_text" data-module_name="block_text">
        ...
        <img class="on-element hide" src="{$moduleImgUri}/wireframe/homepage/block_text-selected.jpg"/>
    </div>
    <div class="col-xs-12 js-img-home_products" data-module_name="home_products">
        ...
        <img class="on-element hide" src="{$moduleImgUri}/wireframe/homepage/home_products2-selected.jpg"/>
    </div>
    <div class="col-xs-12 js-img-banner" data-module_name="banner">
        ...
        <img class="on-element hide" src="{$moduleImgUri}/wireframe/homepage/banner-selected.jpg"/>
    </div>
    <div class="col-xs-12 js-img-social_newsletter" data-module_name="social_newsletter">
        ...
        <img class="on-element hide" src="{$moduleImgUri}/wireframe/commons/newsletter-selected.jpg"/>
    </div>
    <div class="col-xs-12 js-img-footer" data-module_name="footer">
        ...
        <img class="on-element hide" src="{$moduleImgUri}/wireframe/commons/footer-selected.jpg"/>
    </div>
</div>
