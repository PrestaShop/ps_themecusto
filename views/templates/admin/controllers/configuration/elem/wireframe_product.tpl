...
<div class="row no-gutter js-wireframe">
    ...
    <div class="col-xs-12 js-img-product_management" data-module_name="product_management">
        ...
        <img class="on-element hide" src="{$moduleImgUri}/wireframe/product/product_mgmt-selected.jpg"/>
    </div>
    <div class="col-xs-12 js-img-product_detail" data-module_name="product_detail">
        ...
        <img class="on-element hide" src="{$moduleImgUri}/wireframe/product/product_detail-selected.jpg"/>
    </div>
    <div class="col-xs-12 js-img-product_block" data-module_name="product_block">
        ...
        <img class="on-element hide" src="{$moduleImgUri}/wireframe/product/products_block-selected.jpg"/>
    </div>
