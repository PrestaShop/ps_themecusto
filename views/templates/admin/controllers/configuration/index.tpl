...
<div id="psthemecusto" class="container-fluid clearfix">
    ...
    <div class="panel row">
        <div class="panel-heading text-center">
            ...
            <button class="btn btn-primary btn-lg selected" data-id-modal="productModal">{l s='Product page' mod='ps_themecusto'}</button>
        </div>
        ...
        {include file="./dropdownList.tpl" elementsList=$productPageList idModal='product' defaultModalClass=''}
    </div>
